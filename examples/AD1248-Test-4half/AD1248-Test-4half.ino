...
//        Serial.println("Conversion Result");
      ...
      case '?':
        ...
        Serial.println("'h' to read continously multiple conversions from different in half bridge inputs");
        Serial.println("'k' to read multiple conversions and average them from different in half bridge inputs");
